...
from carpark_data import CarParkData, CarParkSlot
import time
...
class MotionDetector:
    ...
    def __init__(self, coordinates, start_frame, carPark):
        ...
        self.bounds = []
        self.mask = []
        #self.hasIncomingVideoCaptureChanged = hasIncomingVideoCaptureChanged
                ...
                for index, p in enumerate(coordinates_data):
                    ...
                    if self.carPark.get_carpark_slots()[index] is not None:
                        if color == COLOR_GREEN:
                            ...
                            self.carPark.get_carpark_slots()[index].set_modifiedTime(time.time_ns())
                        else:
